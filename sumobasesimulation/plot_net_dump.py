...
def main(args=None):
    ...
    optParser.add_option("-m", "--measures", dest="measures",
                         default="speed,speed", help="Define which measure to plot")
    ...
    for t in times:
        ...
        sm = plt.cm.ScalarMappable(cmap=matplotlib.cm.get_cmap(options.colormap), norm=plt.Normalize(vmin=0, vmax=1))
